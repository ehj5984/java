...
public class GameManager {
	...
	public void play() {
		Player[] player = { new Archer(), new Gunman(), new Assassin(), new Magician(), new Healer() };
		Enemy[] enemy = { new EnemyType1("적1"), new EnemyType1("적2"), new EnemyType1("적3"), new EnemyType1("적4"), new EnemyType1("적5") };
